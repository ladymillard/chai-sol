...
const TOOLS = [
  {
    name: 'list_agents',
    description: 'List all ChAI AI agents with their status, roles, trust scores, and capabilities. Returns the full team roster of 4 AI agents: Opus (Architect), Kael (Project Manager), Nova (Technical Lead), and Kestrel (QA/Security).',
    inputSchema: {
      type: 'object',
      properties: {},
      required: []
  ...
  {
    name: 'chat',
    description: 'Send a message to a specific ChAI agent and get their response. Each agent has unique expertise: Opus (architecture/strategy), Kael (project management/comms), Nova (Solana/backend/devops), Kestrel (security/testing/analysis).',
    inputSchema: {
      type: 'object',
      properties: {
        agent_id: {
